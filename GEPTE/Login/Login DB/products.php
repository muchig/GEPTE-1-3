...
';
   ...
   while($row = $result->fetch_assoc()) {
    ...
    <div class="card">
    <form method="post" action="./editproduct.php" style="overflow: hidden; height: 450px; ">
        <div class="photo">
                <a href="">
...
echo'
    ...
    <div class="card" id="pluss" style="background-color: black;  opacity: .4;">
    
    <form method="post" action="./additem.php"> 
    <input type="hidden" style="padding: 0;" name="Number" > 
    <input type="image" class="plus" src="./images/plus-icon-black-2.png" style="margin-top: 60px;"/> 
    </form>
